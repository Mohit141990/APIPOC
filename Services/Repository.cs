...
namespace WebAPI5.Services
{
    public class Repository<TEntity> : IRepository<TEntity> where TEntity : class
    {
        ...
        public Repository(DatabaseContext context, IConfiguration configuration)
        {
            Context = context;
...
;
        ...
        public void ChangeEntityCollectionState<T>(ICollection<T> entityCollection, Enums.ObjectState state) where T : class
        {
        ...
        public void ChangeEntityState(TEntity entity, Enums.ObjectState state)
        {
        ...
        private EntityState ConvertState(Enums.ObjectState state)
        {
            switch (state)
            {
                case Enums.ObjectState.Added:
                    return EntityState.Added;
                case Enums.ObjectState.Deleted:
                    return EntityState.Deleted;
                case Enums.ObjectState.Modified:
